...
define('ghost/templates/components/gh-navitem', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("        <button type=\"button\" class=\"add-navigation-link icon-add\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "addItem", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING"],"contexts":[depth0],"data":data})));
  data.buffer.push(">\n            <span class=\"hidden\">Add</span>\n        </button>\n");
  return buffer;
},"3":function(depth0,helpers,partials,data) {
  var escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("        <button type=\"button\" class=\"navigation-delete icon-trash\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "deleteItem", "navItem", {"name":"action","hash":{},"hashTypes":{},"hashContexts":{},"types":["STRING","ID"],"contexts":[depth0,depth0],"data":data})));
  data.buffer.push(">\n            <span class=\"hidden\">Delete</span>\n        </button>\n");
  return buffer;
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("<button type=\"button\" class=\"navigation-item-drag-handle icon-grab\">\n    <span class=\"hidden\">Reorder</span>\n</button>\n<div class=\"navigation-inputs\">\n    <span class=\"navigation-item-label\">\n        ");
  data.buffer.push(escapeExpression(((helpers['gh-trim-focus-input'] || (depth0 && depth0['gh-trim-focus-input']) || helperMissing).call(depth0, {"name":"gh-trim-focus-input","hash":{
    ...
    'placeholder': ("Label"),
    'focus': ("navItem.last")
  },"hashTypes":{'value': "ID",'placeholder': "STRING",'focus': "ID"},"hashContexts":{'value': depth0,'placeholder': depth0,'focus': depth0},"types":[],"contexts":[],"data":data}))));
  data.buffer.push("\n    </span>\n    <span class=\"navigation-item-url\">\n        ");
  data.buffer.push(escapeExpression(((helpers['gh-navitem-url-input'] || (depth0 && depth0['gh-navitem-url-input']) || helperMissing).call(depth0, {"name":"gh-navitem-url-input","hash":{
    'change': ("updateUrl"),
    'url': ("navItem.url"),
    'baseUrl': ("baseUrl")
  },"hashTypes":{'change': "STRING",'url': "ID",'baseUrl': "ID"},"hashContexts":{'change': depth0,'url': depth0,'baseUrl': depth0},"types":[],"contexts":[],"data":data}))));
  data.buffer.push("\n    </span>\n</div>\n<span class=\"navigation-item-action\">\n");
  stack1 = helpers['if'].call(depth0, "navItem.last", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(1, data),"inverse":this.program(3, data),"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
...
define('ghost/templates/posts', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  },"hashTypes":{'title': "STRING",'src': "STRING"},"hashContexts":{'title': depth0,'src': depth0},"types":[],"contexts":[],"data":data})));
  data.buffer.push(">\n                        <span class=\"author\">");
  stack1 = helpers._triageMustache.call(depth0, "post.authorName", {"name":"_triageMustache","hash":{},"hashTypes":{},"hashContexts":{},"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("</span>\n                        <span class=\"status\">\n");
...
define('ghost/templates/settings', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  data.buffer.push("                ");
  data.buffer.push(escapeExpression(((helpers['gh-activating-list-item'] || (depth0 && depth0['gh-activating-list-item']) || helperMissing).call(depth0, {"name":"gh-activating-list-item","hash":{
    'classNames': ("settings-nav-navigation icon-compass"),
    'title': ("Navigation"),
  ...
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  stack1 = helpers['if'].call(depth0, "showNavigation", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(7, data),"inverse":this.noop,"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  stack1 = helpers['if'].call(depth0, "showCodeInjection", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(9, data),"inverse":this.noop,"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  stack1 = helpers['if'].call(depth0, "showLabs", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(11, data),"inverse":this.noop,"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  stack1 = helpers['if'].call(depth0, "showAbout", {"name":"if","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(13, data),"inverse":this.noop,"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("        </ul>\n    </nav>\n\n    ");
  stack1 = helpers._triageMustache.call(depth0, "outlet", {"name":"_triageMustache","hash":{},"hashTypes":{},"hashContexts":{},"types":["ID"],"contexts":[depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
...
define('ghost/templates/settings/navigation', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  data.buffer.push("Back");
  },"3":function(depth0,helpers,partials,data) {
  var helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = '';
  data.buffer.push("            ");
  data.buffer.push(escapeExpression(((helpers['gh-navitem'] || (depth0 && depth0['gh-navitem']) || helperMissing).call(depth0, {"name":"gh-navitem","hash":{
    'updateUrl': ("updateUrl"),
    'deleteItem': ("deleteItem"),
    'addItem': ("addItem"),
    'baseUrl': ("blogUrl"),
    'navItem': ("navItem")
  },"hashTypes":{'updateUrl': "STRING",'deleteItem': "STRING",'addItem': "STRING",'baseUrl': "ID",'navItem': "ID"},"hashContexts":{'updateUrl': depth0,'deleteItem': depth0,'addItem': depth0,'baseUrl': depth0,'navItem': depth0},"types":[],"contexts":[],"data":data}))));
  data.buffer.push("\n");
  return buffer;
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = '';
  ...
  stack1 = helpers.each.call(depth0, "navItem", "in", "navigationItems", {"name":"each","hash":{},"hashTypes":{},"hashContexts":{},"fn":this.program(3, data),"inverse":this.noop,"types":["ID","ID","ID"],"contexts":[depth0,depth0,depth0],"data":data});
  if (stack1 != null) { data.buffer.push(stack1); }
...
define('ghost/templates/settings/users/user', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing, buffer = '';
  data.buffer.push("<header class=\"settings-subview-header clearfix\">\n");
